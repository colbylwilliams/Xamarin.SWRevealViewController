...
namespace Xamarin.SWRevealViewController
{
	...
	interface SWRevealViewControllerDelegate
	{
		...
		void RevealControllerWillMove (SWRevealViewController revealController, FrontViewPosition position);
		...
		void RevealControllerDidMove (SWRevealViewController revealController, FrontViewPosition position);
		...
		void RevealControllerAnimate (SWRevealViewController revealController, FrontViewPosition position);
		...
		bool RevealControllerPanShouldRecognizeSimultaneously (SWRevealViewController revealController, UIGestureRecognizer otherGestureRecognizer);
		...
		bool RevealControllerTapShouldRecognizeSimultaneously (SWRevealViewController revealController, UIGestureRecognizer otherGestureRecognizer);
		...
		void RevealControllerPanGestureBegan (SWRevealViewController revealController, nfloat location, nfloat progress, nfloat overProgress);
		...
		void RevealControllerPanGestureMoved (SWRevealViewController revealController, nfloat location, nfloat progress, nfloat overProgress);
		...
		void RevealControllerPanGesturEnded (SWRevealViewController revealController, nfloat location, nfloat progress, nfloat overProgress);
		...
		void RevealControllerWillAddViewContrller (SWRevealViewController revealController, UIViewController viewController, SWRevealControllerOperation operation, bool animated);
		...
		void RevealControllerDidAddViewContrller (SWRevealViewController revealController, UIViewController viewController, SWRevealControllerOperation operation, bool animated);
		...
		UIViewControllerAnimatedTransitioning RevealControllerAnimationController (SWRevealViewController revealController, SWRevealControllerOperation operation, UIViewController fromVC, UIViewController toVC);
		...
		void RevealControllerPanGestureBegan (SWRevealViewController revealController, nfloat location, nfloat progress);
		...
		void RevealControllerPanGestureMoved (SWRevealViewController revealController, nfloat location, nfloat progress);
		...
		void RevealControllerPanGestureEnded (SWRevealViewController revealController, nfloat location, nfloat progress);
	}

	// @interface SWRevealViewController (UIViewController)
	[Category, BaseType (typeof (UIViewController))]
	interface UIViewController_SWRevealViewController
	{
